...
SpeedController* RobotMap::grabbersGrabberCANTalon = NULL;
...
void RobotMap::init() {
	...
	grabbersGrabbermotor = new TalonSRX(4);
	lw->AddActuator("Grabbers", "Grabbermotor", (TalonSRX*) grabbersGrabbermotor);
