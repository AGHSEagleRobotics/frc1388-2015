...
OI::OI() {
	...
	elevatorLevel1 = new JoystickButton(opStick, 9);
	elevatorLevel1->WhenPressed(new SetSetpoint(19.8));

	elevatorLevel2 = new JoystickButton(opStick, 5);
	elevatorLevel2->WhenPressed(new SetSetpoint(31.9));

	elevatorLevel3 = new JoystickButton(opStick, 7);
	elevatorLevel3->WhenPressed(new SetSetpoint(44));

	elevatorLevel4 = new JoystickButton(opStick, 6);
	elevatorLevel4->WhenPressed(new SetSetpoint(56.1));

	elevatorLevel5 = new JoystickButton(opStick, 8);
	elevatorLevel5->WhenPressed(new SetSetpoint(68.2));
}
